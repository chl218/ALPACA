    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDemo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Client client = new Client(addr, port, -1, -1, -1, -1, -1, -1, 1, amount);
                    client.execute();
                }
                catch(Exception e) {
                    promptError();
        ...
        buttonDemo2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int    port = Integer.parseInt(editTextPort.getText().toString());
                try {
                    Client client = new Client(addr, port, -1, -1, -1, -1, -1, -1, 2, amount);
                    client.execute();
                }
                catch(Exception e) {
                    promptError();
        ...
        buttonDemo3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Client client = new Client(addr, port, -1, -1, -1, -1, -1, -1, 3, amount);
                    client.execute();
                }
                catch(Exception e) {
                    promptError();
